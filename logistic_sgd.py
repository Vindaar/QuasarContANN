...
class LogisticRegression(object):
    ...
    def __init__(self, input, n_in, n_out, W=None, b=None):
        ...
        # Our prediction for a given input is simply the product of input with the 
        # weight matrix + the bias vector -> thus the result is a symbolic vector
    ...
    def prediction_error_sq(self, y):
    ...
    def errors(self, y, threshold = 0.1):
        ...
        # TODO: change implementation of errors to suit regression model
        #       TODO: realized, this function is not needed for cost?!
        #             instead need to put 'float' stuff into function
        #             equivalent to negative_log_likelihood, since that
        #             is the cost function in classification case
        ...
        if y.dtype.startswith('int'):
            ...
            # from the batch, whose error was below a certain threshold.
            #return T.mean((self.y_pred - y)**2)
            # indices to get all model outputs, index for each row
