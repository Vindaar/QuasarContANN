...
def test_dA(args, learning_rate=0.0001, training_epochs=500,
    ...
    image = Image.fromarray(
        tile_raster_images(X=da.W.get_value(borrow=True).T,
                           img_shape=(44, 44), tile_shape=(10, 10),
                           tile_spacing=(1, 1)))
    image.save('filters_corruption_0.png')

    save_file = open('./classifier_params.dA', 'wb')
    cPickle.dump(da.params, save_file, -1)
